...
<div class="w-full max-w-4xl mx-auto px-6 py-5">
    ...
    <div class="flex items-center justify-between mb-3">
        <div>
            <h1 class="text-xl font-semibold text-slate-800">Tambah Buku</h1>
            <p class="text-sm text-slate-500">Isi data buku dengan benar</p>
        </div>
    ...
    <div class="bg-white rounded-lg border border-slate-200">
        <form action="{{ route('admin.buku.store') }}" method="POST" enctype="multipart/form-data" class="p-4">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-3">
                ...
                <div class="md:col-span-2">
                    ...
                    <div id="dropzone"
                        ...
                        <div id="previewWrap" class="shrink-0">
                            <div id="placeholder" class="w-20 h-28 rounded-md border border-slate-200 bg-white flex items-center justify-center">
                                <span class="text-xs text-slate-400">No cover</span>
                            </div>

                            <img id="previewImg" src="" alt="preview"
                                 class="hidden w-20 h-28 object-cover rounded-md border border-slate-200 bg-white" />
                        </div>
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-2 flex items-center gap-2">
                                ...
                                <button type="button" id="btnRemove"
                                        class="px-3 py-2 rounded-md bg-slate-100 text-slate-700 hover:bg-slate-200 text-xs hidden">
                                    Hapus
                                </button>
                                <span id="fileName" class="text-xs text-slate-600 truncate"></span>
                            </div>
                        </div>
                    </div>

                    <p class="mt-2 text-xs text-slate-500">
                        Tip: kalau salah pilih, klik <b>Hapus</b> lalu pilih lagi.
                    </p>
                </div>
